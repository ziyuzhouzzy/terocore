...
HD_PWD='D:/vivadoproject/Tero/Tero.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_config.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_config.tcl
