...
HD_PWD='D:/vivadoproject/Tero/Tero.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_config.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_config.tcl -notrace
